...
/// MAC нашего HM10 (модуль переименован в OBYEZD57A1). На Android remoteId == MAC.
/// Привязка к замку идёт по этому адресу, а не по имени.
const String kHm10Mac = 'E0:E5:CF:A2:BB:46';

/// Устройство HM10 по фиксированному MAC — можно подключаться без скана.
BluetoothDevice hm10Device() => BluetoothDevice.fromId(kHm10Mac);
